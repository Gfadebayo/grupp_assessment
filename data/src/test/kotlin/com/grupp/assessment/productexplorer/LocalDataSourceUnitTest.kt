...
class LocalDataSourceUnitTest {
    ...
    fun testInsertProduct() {
        runTest {
            ...
            localSource.insert(listOf(product))
    ...
    private val dummyProduct = com.grupp.assessment.productexplorer.domain.Product(
        id = "5",
        title = "John Hardy Women's Legends Naga Gold & Silver Dragon Station Chain Bracelet",
        price = "300",
        description = "From our Legends Collection, the Naga was inspired by the mythical water dragon that protects the ocean's pearl. Wear facing inward to be bestowed with love and abundance, or outward for protection.",
        category = com.grupp.assessment.productexplorer.domain.Category.JEWELERY,
        imageUrl = "https://fakestoreapi.com/img/71pWzhdJNwL._AC_UL640_QL65_ML3_.jpg",
        rating = com.grupp.assessment.productexplorer.domain.Rating(rate = "4.6", count = "900")
    )
}